...
`user_group_permissions.yaml <https://github.com/bluesky/bluesky-queueserver/blob/main/src/bluesky_queueserver/profile_collection_sim/user_group_permissions.yaml>`_,
